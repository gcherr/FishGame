...
public class GameResult extends JFrame
{
 ...
 public GameResult(Boolean result)
 {
  ...
  ClassLoader cldr = this.getClass().getClassLoader();
    ...
    try {
   URL lostURL   = cldr.getResource("Graphics/youLost1.gif");
   ImageIcon lost1 = new ImageIcon(lostURL);
   lost = lost1.getImage();
   URL playAgainURL = cldr.getResource("Graphics/playAgain.gif");
   ImageIcon play = new ImageIcon(playAgainURL);
   playAgain = play.getImage();
   URL winURL   = cldr.getResource("Graphics/youWin1.gif");
