...
public class GameGui extends JFrame
{
 ...
 public GameGui()
 {
  ...
  ClassLoader cldr = this.getClass().getClassLoader();
     ...
     try {
   URL bgURL   = cldr.getResource("Graphics/background.gif");
   ImageIcon bg1 = new ImageIcon(bgURL);
   background = bg1.getImage();

   URL instURL   = cldr.getResource("Graphics/instructions.gif");
   ImageIcon inst1 = new ImageIcon(instURL);
   instruction = inst1.getImage();

   URL netURL   = cldr.getResource("Graphics/net.gif");
   ImageIcon net1 = new ImageIcon(netURL);
   net = net1.getImage();

   URL oFishURL   = cldr.getResource("Graphics/oFish.gif");
   ImageIcon oFish1 = new ImageIcon(oFishURL);
   oFish = oFish1.getImage();

   URL pURL   = cldr.getResource("Graphics/pFish.gif");
